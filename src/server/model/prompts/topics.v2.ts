    ...
    return JSON.stringify(
      {
        ...
        instruction:
          "Return JSON: {\"topics\":[{ \"id\":\"topic-candidate-<n>\", \"label\":\"...\", \"description\":\"...\", \"supportingReviewIds\":[\"review-id\",...], \"quote\":\"exact substring\" }]} — at most 6 topics.",
      },
      null,
      2,
    );
...
export const topicConsolidationPrompt: PromptDefinition<TopicConsolidationOutput> = {
  ...
  version: "topics.consolidation@2",
    ...
    return JSON.stringify(
      {
        ...
        outputLocale: c.outputLocale,
        instruction:
          "Return JSON: {\"topics\":[{ \"id\":\"topic-<n>\", \"label\":\"...\", \"description\":\"...\", \"candidateIds\":[\"topic-candidate-<n>\",...] }]} — at most 20 topics.",
      },
      null,
      2,
    );
