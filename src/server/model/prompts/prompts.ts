...
import { requirementEvidencePrompt } from "./requirement-evidence.v1";
...
export const PromptRegistry: PromptRegistryType = {
  ...
  [requirementEvidencePrompt.id]: requirementEvidencePrompt,
...
export * from "./requirement-evidence.v1";
